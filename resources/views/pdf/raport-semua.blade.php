...
<head>
    <meta charset="UTF-8" />
    <title>Raport Semua Siswa – {{ $pengajuan->rombel->nama }} – {{ $pengajuan->semester->nama }}</title>
    <style>
        @page {
        ...
        * {
        ...
        .row-lulus    { background-color: #ffffff; }
        .row-alt      { background-color: #f5f7fb; }
        .row-tidak-lulus { background-color: #fff0f0; }
...
@foreach($siswaData as $idx => $sd)
@php
    $siswa        = $sd['peserta'];
    $nilaiRows    = $sd['nilaiRows'];
    $absensiRekap = $sd['absensiRekap'];
@endphp
...
<div class="page-wrapper">
    ...
    <div class="page-footer">
        ...
        &nbsp;·&nbsp;
        Halaman {{ $idx + 1 }} dari {{ count($siswaData) }}
    </div>
