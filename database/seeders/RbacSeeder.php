    ...
    public function run(): void
    {
        ...
        if ($guruRole) {
            $guruPermissions = Permission::whereIn('permission_name', [
                ...
                'admin.akademik.absensi.list',
                'admin.akademik.absensi.detail',
                'admin.akademik.absensi.siswa',
                'admin.akademik.absensi.store',
                'admin.akademik.absensi.update',
                'admin.akademik.absensi.destroy',
                'admin.akademik.absensi.rekap',
                'admin.akademik.absensi.rekap-pdf',
                'admin.akademik.absensi.rekap-excel',
                'admin.akademik.absensi.tap',
                'admin.akademik.absensi.tap.scan',
