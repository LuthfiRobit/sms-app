...
class CheckPermission
{
    ...
    protected array $permissionAliases = [
        ...
        'admin.akademik.rpp.list' => 'admin.akademik.rpp.index',
        'admin.akademik.rpp.guru-mapel' => 'admin.akademik.rpp.index',
        'admin.akademik.rpp.duplicate' => 'admin.akademik.rpp.store',
        'admin.akademik.rpp-compliance.index' => 'admin.akademik.rpp.index',
        'admin.akademik.rpp-compliance.list' => 'admin.akademik.rpp.index',
        'admin.akademik.rpp-template.bagian.store' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.bagian.update' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.bagian.destroy' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.poin.store' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.poin.update' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.poin.destroy' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.poin.reorder' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.opsi.index' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.opsi.store' => 'admin.akademik.rpp-template.index',
        'admin.akademik.rpp-template.opsi.update' => 'admin.akademik.rpp-template.index',
